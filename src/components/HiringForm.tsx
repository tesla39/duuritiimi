...
export function HiringForm({ type, onSuccess }: HiringFormProps) {
        ...
        <div className="flex gap-2">
          <Popover>
            ...
            <PopoverContent className="w-auto p-0 bg-gray-800 border-gray-700">
              <Calendar
                mode="single"
                selected={formData.fromDate || undefined}
          ...
          <Select
            ...
            onValueChange={(value) => handleTimeChange('fromTime', value)}
          >
        ...
        <div className="flex gap-2">
          <Popover>
            ...
            <PopoverContent className="w-auto p-0 bg-gray-800 border-gray-700">
              <Calendar
                mode="single"
                selected={formData.toDate || undefined}
          ...
          <Select
            ...
            onValueChange={(value) => handleTimeChange('toTime', value)}
          >
            <SelectTrigger className="w-[110px] bg-gray-800 border-gray-700 text-white">
              <Clock className="mr-2 h-4 w-4" />
              <SelectValue placeholder="Time" />
